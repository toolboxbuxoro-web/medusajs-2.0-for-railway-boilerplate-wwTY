      ...
      {isDetails && (
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap items-center gap-6 text-sm pt-4 border-t border-gray-100">
             ...
             {metadata.brand && (
              <div className="flex flex-col gap-1">
                <span className="text-gray-400 text-xs uppercase tracking-wider font-semibold">Бренд</span>
            ...
            {/* Rating */}
            <div className="flex flex-col gap-1">
              <span className="text-gray-400 text-xs uppercase tracking-wider font-semibold">Рейтинг</span>
              <div className="flex items-center gap-1 text-orange-400">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
                <span className="font-bold text-gray-900">4.8</span>
                <span className="text-gray-400 font-normal">(42 отзыва)</span>
              </div>
            </div>

            {/* Code */}
            <div className="flex flex-col gap-1">
              <span className="text-gray-400 text-xs uppercase tracking-wider font-semibold">Артикул</span>
            ...
            {warrantyYears && (
              <div className="flex flex-col gap-1">
                <span className="text-gray-400 text-xs uppercase tracking-wider font-semibold">Гарантия</span>
          ...
          {(getLocalizedField(product, "description", localeStr) || product.description) && (
            <div className="pt-6 border-t border-gray-100">
              <Heading level="h2" className="text-lg font-bold mb-4">Описание</Heading>
