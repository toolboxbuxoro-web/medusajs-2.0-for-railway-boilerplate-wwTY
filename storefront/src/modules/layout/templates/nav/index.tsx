      ...
      <div className="relative bg-white border-b border-gray-200">
        ...
        >
          <div className="flex flex-col w-full">
            <div className="content-container flex items-center justify-between h-14 sm:h-16 lg:h-18 gap-1 sm:gap-3 lg:gap-6 navbar-header-content relative px-2 sm:px-0">
            ...
            <div className="flex items-center gap-0.5 sm:gap-1 md:gap-2 lg:gap-3 navbar-icons ml-auto sm:ml-0">
              ...
              <a
                ...
                className="sm:hidden px-2 py-1.5 mr-2 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors flex items-center justify-center"
