...
export const retrieveCollection = cache(async function (id: string) {
  return sdk.store.collection
    // @ts-ignore
    .retrieve(id, { fields: "+metadata" }, { next: { tags: ["collections"], revalidate: 3600 } })
...
export const getCollectionsList = cache(async function (
  ...
  return sdk.store.collection
    // @ts-ignore
    .list({ limit, offset, fields: "+metadata" }, { next: { tags: ["collections"], revalidate: 3600 } })
    .then(({ collections }) => {
...
export const getCollectionByHandle = cache(async function (
  ...
  return sdk.store.collection
    // @ts-ignore
    .list({ handle, fields: "+metadata" }, { next: { tags: ["collections"], revalidate: 3600 } })
