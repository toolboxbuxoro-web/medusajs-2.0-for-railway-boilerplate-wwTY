...
/**
 * MXIK (IKPU) Widget for Category Details
 * Category MXIK is used as fallback for products without their own MXIK
 */
const CategoryMxikWidget = ({ data }: WidgetProps) => {
  ...
  return (
    <div style={{ 
      ...
      <div style={{ padding: "16px", borderBottom: "1px solid #e5e7eb" }}>
        <h2 style={{ margin: 0, fontSize: "14px", fontWeight: 600 }}>MXIK категории</h2>
      </div>
      <div style={{ padding: "16px" }}>
        <p style={{ margin: "0 0 12px", fontSize: "13px", color: "#6b7280" }}>
          MXIK код для всех товаров категории
        </p>
        ...
        <p style={{ margin: "12px 0 0", fontSize: "11px", color: "#9ca3af" }}>
          Товары без своего MXIK используют этот код
        </p>
      </div>
    </div>
  )
...
export default CategoryMxikWidget
