        ...
        if (orderId) {
          ...
          try {
            ...
            if (paymentId) {
              ...
              this.logger_.info(`[PaymeMerchant] ✅ Captured payment ${paymentId} for order ${orderId}`)
            } else {
              this.logger_.warn(`[PaymeMerchant] No payment found for collection ${session.payment_collection_id}`)
            }
