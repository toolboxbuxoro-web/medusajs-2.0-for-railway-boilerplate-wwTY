          ...
          products: {
            ...
            indexSettings: {
              ...
              synonyms: {
                ...
                "шуруповерт": ["шуруповёрт", "screwdriver", "шурик", "винтоверт", "винтовёрт"],
                "шуруповёрт": ["шуруповерт", "screwdriver", "шурик", "винтоверт", "винтовёрт"],
                "гайковерт": ["гайковёрт", "гайк", "impact wrench"],
                "гайковёрт": ["гайковерт", "гайк", "impact wrench"],
                "отвертка": ["отвёртка", "отвёрт", "screwdriver"],
                "отвёртка": ["отвертка", "отвёрт", "screwdriver"],
